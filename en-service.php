...
foreach($productData as $firstProduct)
{
  ...
  echo"<div class='data-of-product'dir='ltr' style='left: 18px;'><h2> ".$firstProduct['name'] ."</h2><p>". $firstProduct['description'] ."</p><ul >";
  ...
  </div>";  echo "<img style='margin-left:15px' id='photo' src=images/" . $firstProduct['image'] ." alt='Product Photo'>";
                    $flag=false;
                    break;
                } 
            } else {
